...
- **Selection strategy is configurable.** New sessions default to round-robin across
  ...
  within **10 pp** of `rateLimitPct` on either window is held back. The 5-hour band keeps the
